...
public class Boomer : Enemy
{
    ...
    IEnumerator AttackCo()
    {
        ...
        GameObject missile = Instantiate(enemyMissile, transform.position += Vector3.up*2, transform.rotation);
        Rigidbody missileRigid = missile.GetComponent<Rigidbody>();
        missileRigid.velocity = transform.forward * 40;
    ...
    IEnumerator OnDamage()
    {
        ...
        _enemyMaterial.color = Color.black;
